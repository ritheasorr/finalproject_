  ...
  return (
    <div className="surface-card overflow-hidden">
      <div className="h-52 md:h-64 relative">
        <img src={coverImage} alt={`${name} cover`} className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0a3f30]/45 to-transparent" />
      </div>

      <div className="px-5 md:px-8 pb-6">
        <div className="-mt-14 md:-mt-16 relative z-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div className="flex items-end gap-4">
            <div className="w-24 h-24 md:w-28 md:h-28 rounded-full border-4 border-white bg-[#e8f5ef] shadow-lg overflow-hidden flex items-center justify-center text-[#0f5d43] text-2xl font-bold">
              {avatarImage ? (
